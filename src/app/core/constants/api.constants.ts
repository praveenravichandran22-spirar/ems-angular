...
export const API_ROUTES = {
  ...
  employees: {
    ...
    assignWorkflow: (id: number) => `${API_BASE_URL}/employees/${id}/assign-workflow`,
    submit:         (id: number) => `${API_BASE_URL}/employees/${id}/submit`,
    review:         (id: number) => `${API_BASE_URL}/employees/${id}/review`,
    approve:        (id: number) => `${API_BASE_URL}/employees/${id}/approve`,
    workflowHistory:(id: number) => `${API_BASE_URL}/employees/${id}/workflow-history`,
    pendingReview:  `${API_BASE_URL}/employees/pending-review`,
    pendingApproval:`${API_BASE_URL}/employees/pending-approval`,
  },
  users: {
    base:      `${API_BASE_URL}/users`,
    reviewers: `${API_BASE_URL}/users/reviewers`,
    approvers: `${API_BASE_URL}/users/approvers`,
  },
  students: {
